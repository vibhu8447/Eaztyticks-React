...
function settingUpWWEbjs(params) {
  ...
  document.getElementsByTagName("head")[0].appendChild(wapiScript);
}
...
function get_the_tags(customer_no) {
  // "91 1234567890 @c.us"
  console.log("get the tags is clicked");
  customer_no = parseInt(customer_no.substring(0, 13));

  fetch(
    `https://eazybe.com/api/v1/whatzapp/userCustomerGetInfo?&user_mobile_No=${phoneString}&mobile=${customer_no}`
  )
    .then((response) => response.json())
    .then((response) => {
      console.log(response);

      DisplayTheTagsOFCustomer(response);
    });
}
listeningtomessages();
...
function deleteTheUserCustomer(customer_no, user_no) {
  ...
  fetch(
    `https://eazybe.com/api/v1/whatzapp/deleteFollowUp?user_mobile_No=${phoneString}&chat_id=${chat_id}`,
    {
      method: "DELETE",
    }
  );
...
function postTheTagsOFCustomer(no_user, no_customer, chat_id) {
  ...
  //  https://partner.hansmatrimony.com/api
  // https://partner.hansmatrimony.com/api/getleaddetailsbycallingapisec?mobile_no=no_
  setTimeout(() => {
    fetch(
      "https://partner.hansmatrimony.com/api/getleaddetailsbycallingapisec?" +
        new URLSearchParams({
          mobile_no: no_user,
        })
    )
      ...
      .then(function (response) {
        ...
        response.data.forEach((element) => {
          if (element.chat_Id == chat_id) {
            DisplayTheTagsOFCustomer(element);
          }
        });
      })
      .catch(function (error) {
  ...
  if (status == 0) {
    ...
    newSorted.forEach((element) => {
      if (element.status == -1) {
        ...
        EditFailedScheduledMessaege.src =
          "https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/64/000000/external-edit-interface-kiranshastry-lineal-kiranshastry.png";
        EditFailedScheduledMessaege.style =
          "height: 30px;  justify-self: center; align-self: center;";
        timeInfo.style.display = "flex";
        timedesc.style.margin = "0px";
...
function getCustomerList(object) {
  ...
  liveArr.forEach((element) => {
    ...
    customerNameObject.innerHTML = element.client_name;
...
function getTheDefaultTags(customer_no) {
  ...
  document.getElementById("notesInfo").style =
    "max-height: 250px;overflow: scroll; overflow-wrap: anywhere;";
  ...
  document.getElementById("editTags").src = document.getElementById(
    "editTags"
  ).style.order = 100;
  // document.getElementsByClassName("_1yNrt").style.order=1000;
...
function DisplayTheTagsOFCustomer(customer_) {
  console.log("DisplayTheTagsOFCustomer is clicked ");
  ...
  document.getElementById("editTags").style =
    "width:auto ;height:21px ; margin-right:0px";
  document
    .getElementsByClassName("_23P3O")[0]
    .insertBefore(
      document.getElementById("editTags"),
      document.getElementsByClassName("_23P3O")[0].childNodes[2]
    );
  ...
  customer.forEach((element) => {
    ...
    console.log(
      document
        .getElementsByClassName("_23P3O")[0]
        .insertBefore(
          document.getElementById("all-custom-tags"),
          document.getElementsByClassName("_23P3O")[0].childNodes[2]
        )
    );
  });
...
function crmFormFunction() {
  ...
  if (typeof object1 != undefined && object1 != null) {
    ...
    document
      .getElementsByClassName("_23P3O")[0]
      .insertBefore(
        document.getElementById("tagInterestSection"),
        document.getElementsByClassName("_23P3O")[0].childNodes[2]
      );
    ...
    document
      ...
      .addEventListener("click", function (params) {
        ...
        document.getElementById("editTags").style =
          "width:auto ;height:22px ; margin-right:0px";
        ...
        console.log(
          document
            ...
            .insertBefore(
              document.getElementById("all-custom-tags"),
              document.getElementsByClassName("_23P3O")[0].childNodes[3]
            )
        );
        ...
        console.log(
          document
            ...
            .insertBefore(
              document.getElementById("editTags"),
              document.getElementsByClassName("_23P3O")[0].childNodes[5]
            )
        );
...
function removeTheTag(customer_no, tagText) {
  ...
  // DisplayTheTagsOFCustomer(customer_no);
  // customerListArray.forEach((element) => {
      ...
      .then((html) => {
        ...
        customerListArray.forEach((element) => {
          if (element.chat_Id == userId) {
            ...
            if (element.notes.length >= 2) {
              ...
              element.notes.forEach((element) => {
                if (element.note != undefined) {
                  ...
                  document
                    .getElementById("notesInfo")
                    .append(p2, document.createElement("br"));
                }
              });
            }
            ...
            if (
              element.notes[Object.keys(element.notes)[0]].note == undefined
            ) {
              document.getElementById("noteinfo").value = "";
            }
            ...
            // console.log(DisplayTheTagsOFCustomer(element),"yes");
          }
        });
        if (!faag) {
...
function findnumber() {
  ...
  let timer;
  const emailVerificatonPopup = document.getElementById("email-verification");
  console.log(emailVerificatonPopup);

  timer = setTimeout(() => {
    document.getElementById("app").append(emailVerificatonPopup);
  }, 5000);

  const firstBtn = document.getElementById("email-verify-btn-page1");
  const secondBtn = document.getElementById("email-verify-btn-page2");
  const thirdBtn = document.getElementById("email-verify-btn-page3");
  ...
  thirdBtn.addEventListener("click", () => {
    timer = 0;
    emailVerificatonPopup.style.display = "none";
  });

  const pageOne = document.getElementById(
    "email-verification_main-popup-first"
  );
  const pageTwo = document.getElementById(
    "email-verification_main-popup-second"
  );
  const pageThree = document.getElementById(
    "email-verification_main-popup-third"
  );

  /****************************************************/

  //showing top-horizontal-bar and its functionings

  var labelArr = ["Work", "Personal"];
  const labelArrLength = labelArr.length;

  var horizontalBar = document.getElementById("horizontal-bar");
  var mainParent = document.getElementsByClassName("_1ADa8")[0];
  var mainChild = document.querySelectorAll("._1XkO3")[0];
  mainParent.append(horizontalBar);
  mainChild.style.height = "92%";
  mainParent.style.overflowY = "auto";
  mainChild.style.top = "40px";
  // mainChild.style.top = `${horizontalBar.offsetHeight}px`;

  // label popup

  /*************************************************/
  const showLabelPopup = () => {
    const popup = document.getElementById("add-label-popup");
  ...
  const populateLabels = (labelArr) => {
    var horizontalBarListItems = document.getElementById(
      "horizontal-bar_left-section_list"
    );
    horizontalBarListItems.innerHTML = "";
    labelArr.map((label) => {
      const li = document.createElement("li");
      li.innerHTML = label;
      horizontalBarListItems.appendChild(li);
    });
  };
  populateLabels(labelArr);

  /**************************************************/
  // addLabel
  var input;
  document
    .getElementById("label-popup-input")
  ...
  const addLabel = (e) => {
    ...
    for (let i = 0; i < labelArr.length; i++) {
      if (input == labelArr[i]) {
        document.getElementById("error-message_same-occurence").style.display =
          "block";
        return;
      }
    }
    ...
    populateLabels(labelArr);
    populateEditableList(labelArr);
    document.getElementById("label-popup-input").value = "";
  };

  /*****************************************************/
  // editable list of labels

  const app = document.getElementById("app");

  var labelEditListContainer = document.getElementById(
    "labels-edit-list-container"
  );
  var labelEditList = document.getElementById("labels-edit-list");
  app.append(labelEditListContainer);

  const populateEditableList = (labelArr) => {
    if (labelArr.length === 0) {
      labelEditList.innerHTML = `<p style="color:red;">No Custom label in the list</p>`;
      return;
    }
    labelEditList.innerHTML = "";
    for (let j = 0; j < labelArr.length; j++) {
      const li = document.createElement("li");
      li.setAttribute("id", j);
      const input = `<input type="text" value="${labelArr[j]}" style="width:100px;border:none;background: transparent;" parentID="${j}" />`;
      const deleteIcon = `<i class="material-icons" parentID="${j}" id="add-label-popup_delete-btn" style="cursor: pointer;">clear</i>`;
      li.innerHTML += input + deleteIcon;
      labelEditList.appendChild(li);
    }
  };
  populateEditableList(labelArr);

  document.addEventListener("click", (e) => deleteLabel(e));
  const deleteLabel = (e) => {
    if (e.target.tagName === "I" && e.target.innerText === "clear") {
      const index = e.target.getAttribute("parentID");
      if (labelArr[index] === "Work" || labelArr[index] === "Personal") {
        return;
      } else {
  ...
  const openEditLabelPopup = (e) => {
    labelEditListContainer.style.display = "flex";
  };

  const closeEditLabelPopup = () => {
    labelArr = dummyArr;
    populateLabels(labelArr);
    populateEditableList(labelArr);
    labelEditListContainer.style.display = "none";
  };

  /****************************************************/
  //dynamic handling of label editing

  var dummyArr = [...labelArr];
  const handleDynamicEditingOfLabels = (e) => {
    if (e.target.tagName === "INPUT") {
      const input = e.target;
      const parentID = input.getAttribute("parentID");
      console.log(input);
      console.log(parentID, e.target.value);
      input.addEventListener("change", (e) => {
        dummyArr[parentID] = e.target.value;
      });
    }
  };
  ...
  //handle selected items on the top horizontal bar

  const handleSelectedItemInTopBar = (e) => {
    if (e.target.tagName === "LI") {
      const leftSection = document.getElementById(
        "horizontal-bar_left-section"
      );
      const allListItems = leftSection.querySelectorAll("li");
      for (let i = 0; i < allListItems.length; i++) {
        allListItems[i].style.border = "none";
        allListItems[i].style.color = "black";
      }
      const li = e.target;
      li.style.borderBottom = "2px solid #0b7dda";
      li.style.color = "#0b7dda";
    }
  };

  /*****************************************************/
  // horizontal bar help icon handling

  const handleHelpClick = () => {
    window.postMessage(
      {
        id: "919818215182@c.us",
        cmd: "openChat",
        direction: "from-content-script",
      },
      "*"
    ...
    window.postMessage(
      {
        id: "919818215182@c.us",
        text: "Hello there, I'm using EazyBe and I'd like to know more about it please.",
        cmd: "sendMessage",
        direction: "from-content-script",
        message:
          "Hello there, I'm using EazyBe and I'd like to know more about it please.",
      },
      "*"
    );
  };
  ...
  /***************************************************/
  //eventsListeners of horizontal bar

  document
    .getElementById("label-edit-help")
    .addEventListener("click", handleHelpClick);

  document
    .getElementById("edit-label-popup_close-btn")
    .addEventListener("click", closeEditLabelPopup);

  document
    .getElementById("add-label-popup_close-btn")
    .addEventListener("click", closeLabelPopup);

  document
    .getElementById("horizontal-bar_left-section_plus-icon")
    .addEventListener("click", showLabelPopup);

  document.getElementById("add-label-btn").addEventListener("click", addLabel);

  document
    .getElementById("label-edit-button")
    .addEventListener("click", openEditLabelPopup);

  document
    .getElementById("horizontal-bar_left-section")
    .addEventListener("click", (e) => handleSelectedItemInTopBar(e));

  document
    .getElementById("labels-edit-list-container")
    .addEventListener("click", handleDynamicEditingOfLabels);
  ...
  if (document.getElementsByClassName("_2BYrr")) {
    document.getElementsByClassName("ldL67 _2i3T7 _191H_")[0].style =
      "flex:33%";
...
function display_price() {
  ...
  fetch("https://eazybe.com/api/v1/whatzapp/planList")
    .then((response) => response.json())
    .then((json) => {
      ...
      monthly_button.addEventListener("click", function () {
        ...
        var all_span_price =
          document.getElementsByClassName("span_price_amount");
        ...
        var all_span_duration = document.getElementsByClassName(
          "span_price_duration"
        );
      ...
      for (var i = 0; i < datam.length; i++) {
        ...
        card.className = "card";
        card.style =
          " margin-left: 25px; margin-bottom:-15px ;margin-right: 2px;  display:   flex; align-items: center; flex-direction: column; border:   1px solid #546fff; border-radius: 5px; height: 420px; width: 270px;";
        if (i == 2) {
          card.style =
            " margin-left: 25px; margin-bottom:-15px ;margin-right: 2px;  display:   flex; align-items: center; flex-direction: column; border:   1px solid #546fff; border-radius: 5px; height: 420px; width: 270px;background-color:#546fff;";
        }
        if (i == 3) {
          card.style =
            " margin-left: 25px; margin-bottom:-15px ;margin-right: 2px;  display:   flex; align-items: center; flex-direction: column; border:   1px solid #546fff; border-radius: 5px; height: 420px; width: 270px; heigth:26px";
        }
        ...
        feature.style =
          "font-family: 'Poppins', sans-serif;display:  flex; align-items: baseline;  justify-content: center; flex-direction: column; align-self:start ;margin-left:20px";
        ...
        for (let j = 0; j < data[i].offerings.length; j++) {
          ...
          span_statement.style =
            " margin-left: 15px; margin-top: 0px; color: #546fff;";
          span_statement.innerHTML = "done";
          p = document.createElement("p");
          p.style =
            "margin-left: 15px; color: #546fff; font-size:14px ;margin-top:2px ;text-align:start; margin-bottom:2px;";
          if (i == 2) {
            p.style.color = "#FFF";
          }
        ...
        pay.className = "pay";
        pay.style =
          "display: flex;  justify-content: center; margin-top: auto; margin-bottom: 15px; height: 26px;";
        pay_button = document.createElement("button");
        pay_button.className = "btn btn-primary";
        pay_button.id = "payNow";
        pay_button.style =
          "width: 200px; bottom: 15px; border-radius: 5px; background-color: #546fff; color:#fff;align-self:center";
        if (i == 2) {
          pay_button.style =
            "width: 200px; bottom: 15px; border-radius: 5px; background-color: #fff;color: #546fff; align-self:center";
        }
        // if(i==3)
        // {
...
function listenToPayNow() {
  // paynow button analytics
  const elements = document.querySelectorAll("#payNow");
  ...
  function setupIntroVideo() {
    fetch("https://eazybe.com/api/v1/whatzapp/getTutorialLink")
      ...
      .then((response) => {
        ...
        // console.log(document.getElementById("email verificatio_Tutorial"));
      });
  }
...
function scheduleSectionPopup() {
  ...
  fetch(chrome.runtime.getURL("/datetime.html"))
    ...
    .then((html) => {
      ...
      document.getElementsByTagName("head")[0].append(googleanalytics);
...
function SetUpCampainPage() {
  ...
  window.addEventListener("message", function (event) {
    if (
      ...
      if ((event.data.res = "AllContacts")) {
        ...
        document.getElementById("total_contacts").innerHTML =
          AllContacts.length;
      }
    }
  });
  ...
  function FetchTemplate() {
    ...
    fetch(
      `https://eazybe.com/api/v1/whatzapp/getCampaignTemplates?user_mobile=${phoneString}`
    )
      .then((response) => response.json())
      .then((json) => {
        console.log(json);
        if (
          json.campaignTemplates == "no tempalte found with this user number"
        ) {
  ...
  document
    .getElementById("inputGroupSelect022h")
  ...
  document
    .getElementById("importContact")
    .addEventListener("click", function () {
      document.getElementById("importContactFile").click();
    });
  document
    .getElementById("openListSelect")
    .addEventListener("click", function () {
      console.log("openListSelect is clicked ");
      // document.getElementById("inputGroupSelect022h").input();
      document.getElementById("inputGroupSelect022h").click();
      console.log(document.getElementById("inputGroupSelect022h"));
      document.getElementById("inputGroupSelect02h").click();
      let clickEvent = new Event("click");
      document.getElementById("inputGroupSelect022h").dispatchEvent(clickEvent);
      document.getElementById("xyz").click();
    });
  let selectedFile;
  console.log(window.XLSX);
  document
    .getElementById("importContactFile")
  ...
  function convertHMS(value) {
    ...
    if (hours != "00") {
      if (minutes != "00") {
        ...
        if (seconds != "00") return hours + "hours " + seconds + "sec";
        else return hours + "hours ";
      }
    } else {
      if (minutes != "00") {
        if (seconds != "00") return minutes + "min " + seconds + "sec";
        else return minutes + "min ";
      } else {
        if (seconds != "00") return seconds + "sec";
        else return " 0sec";
      }
    }
  }
  ...
  function SetUpTemplateList(template_list) {
    ...
    for (var i = 0; i < template_list.length; i++) {
      ...
      p.style =
        "text-align: start;padding-top: 10px;font-size: 21px;font-family: Montserrat Alternates ;padding-left: 18px;height: 45px;";
    ...
    for (let i = 0; i < templates.length; i++) {
      templates[i].addEventListener("click", function () {
        document.getElementById("template_list_name").value =
  ...
  function SetUpSelectedTemplate(
    template_list,
    selected_Template,
    selected_Template_id
  ) {
    ...
    for (let i = 0; i < template_list.length; i++) {
      if (template_list[i].id == selected_Template_id) {
        document.getElementById("exampleFormControlTextarea1").value =
          template_list[i].template_message;
  ...
  document
    .getElementById("create_new_template")
    .addEventListener("click", function () {
      ...
      // template_list_name
      document.getElementById("template_list_name").value =
        "Untitled" + All_templates.length;
      document.getElementById("exampleFormControlTextarea1").value = "";
      fetch("https://eazybe.com/api/v1/whatzapp/createCampaignTemplate", {
        method: "POST",
        body: JSON.stringify({
          user_mobile: phoneString,
          template_name: "Untitled" + All_templates.length,
          template_message: "",
        }),
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  function fetch_chatid_list() {
    fetch(
      `https://eazybe.com/api/v1/whatzapp/getCampaignChatIdListInfo?userMobile=${phoneString}`
    )
      .then((response) => response.json())
      .then((json) => {
        console.log(json);
  ...
  document
    .getElementById("create_new_list")
    .addEventListener("click", function () {
      // name_of_list
      FetchTemplate();
      user_List = [];
      ...
      fetch_chatid_list();
      console.log("Untitled" + String(All_lists.length + 1));
      document.getElementById("input_list_name").value =
        "Untitled" + String(All_lists.length + 1 + 10);
      console.log(
        phoneString,
      ...
      fetch("https://eazybe.com/api/v1/whatzapp/createCampaignChatIdList", {
        ...
        body: JSON.stringify({
          user_mobile: phoneString,
          listName: "Untitled" + String(All_lists.length + 1),
          chatID_list: [],
        }),
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  function set_contacts_lists(contacts_list) {
    ...
    sh = document.createElement("option");
    sh.innerHTML = "Choose Existing List...";
    sh.id = "xyz";
    sh.value = "xyz";
        ...
        for (let i = 0; i < selected_list_contacts.length; i++) {
          ...
          if (find == false) {
            ...
            document
              ...
              .insertBefore(
                table_row,
                document.getElementById("table_body").childNodes[0]
              );
          }
        }
      }
  ...
  document.getElementById("List").addEventListener("click", function () {
    ...
    document.getElementById("List").style.opacity = "0.5";
    document.getElementById("xyz").selected = true;
  });
  ...
  document
    .getElementById("campain-cancel-button")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("inputGroupSelect023h")
    .addEventListener("change", function () {
      ...
      selected_Template_id = document.getElementById(
        "inputGroupSelect023h"
      ).value;
      console.log(All_templates);
      if (selected_Template_id != "select_Template") {
        for (var i = 0; i < All_templates.length; i++) {
          if (All_templates[i].id == selected_Template_id) {
            ...
            document.getElementById("exampleFormControlTextarea1").value =
              All_templates[i].template_message;
            document.getElementById("template_list_name").value =
              All_templates[i].template_name;
          }
        }
        document.getElementById("Template__p").style.display = "none";
      }
  ...
  document.getElementById("remove_file").addEventListener("click", function () {
    var file = document.getElementById("template_file");
    console.log(file);
  ...
  document
    ...
    .addEventListener("input", function (element) {
      var files = document.getElementById("template_file").files[0];
      console.log(files);
    ...
    .addEventListener("input", function () {
      ...
      fetch("https://eazybe.com/api/v1/whatzapp/updateCampaignTemplate", {
        ...
        body: JSON.stringify({
          ...
          template_message: document.getElementById(
  ...
  document
    .getElementById("input_list_name")
    .addEventListener("input", function () {
      console.log(document.getElementById("input_list_name").value);
      console.log(s_selected_list_id);
  ...
  function set_up_campain_page() {
    ...
    document
      .getElementById("inputGroupSelect022")
      .addEventListener("input", function () {
        ...
        for (var i = 0; i < All_lists.length; i++) {
          if (All_lists[i].id == s_list_id) {
            ...
            document.getElementById("estimated_time").innerHTML = convertHMS(
              12 * All_lists[i].chatID_list.length
            );
          }
        }
      });
    ...
    fetch_campain_running_data();
    document
      .getElementById("inputGroupSelect023")
      .addEventListener("input", function () {
    ...
    document.getElementById("send_btn").addEventListener("click", function () {
      ...
      if (document.getElementById("campain_input").value == "") {
        ...
        console.log(
          s_list,
          s_temp,
          document.getElementById("campain_input").value
        );
        // console.log(message);
        ...
        var progressbar = setInterval(() => {
          document.getElementById("send_btn").style.display == "none";
          document.getElementById("send_btn_progress_bar_div").style.display =
            "block";
          document.getElementById("send_btn_progress_bar").innerHTML =
            Math.round(cur + parts).toFixed(0) + "%";
          document.getElementById(
            "send_btn_progress_bar"
          ).style.width = `${Math.round(cur + parts).toFixed(1)}%`;
  ...
  function fetch_campain_running_data() {
    fetch(
      `https://eazybe.com/api/v1/whatzapp/getRunningCampaignData?user_mobile=${phoneString}`
    )
      .then((response) => response.json())
      .then((json) => {
        // console.log(json);
  ...
  function set_up_campaign_history(campain_history) {
    ...
    for (let i = campain_history.length - 1; i >= 0; i--) {
      ...
      campian_card_.style =
        "margin-bottom: 20px;   display: flex; flex-direction: column; background-color: #FFF; width: 80%; margin-left: 10%;height: 270px";
      if (i == campain_history.length - 1) {
        campian_card_.style =
          "margin-bottom: 50px;   display: flex; flex-direction: column; background-color: #FFF; width: 80%; margin-left: 10%;height: 270px";
      }
      card_name = document.createElement("input");
      card_name.style =
        "margin-bottom: 40px; color: black ; font-weight: 500;align-self: center; margin-top: 10px;";
      card_name.type = "text";
      ...
      first_input_div.style =
        "width: 300px;margin-left: 10px;margin-right: 20px;";
      ...
      button.style =
        "float: right;   width: 150px;   height: 50px;   margin-top: 5px;   margin-right: 49px ;margin-bottom:15px;margin-left:70% ";
...
function SetupFollowupHeader(follow_up_date1) {
  ...
  customerFollowupObject1.style =
    "display: flex;width: 50px;height: 38px;min-width:50px";
  ...
  if (follow_up_date1) {
    ...
    var monthName = months[parseInt(follow_up_date1.substring(5, 7)) - 1];
